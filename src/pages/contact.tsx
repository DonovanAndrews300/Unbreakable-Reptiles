...
import SiteLayout from '../components/SiteLayout';
  ...
  const handleChange = (e: any) => {
    ...
    const { hasCopied, onCopy } = useClipboard('unbreakableexotics@gmail.com');
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              <Stack
                ...
                <Stack
                  ...
                  <Link href="https://www.instagram.com/unbreakable_exotics/">
                  ...
                  <Link href="https://www.morphmarket.com/stores/billyd123_/">
                    <Tooltip label="Morph Market"><IconButton
                      aria-label="MorphMarket"
                      variant="ghost"
                      size="lg"
                      icon={<GiSandSnake size="28px" />}
                      _hover={{
                        bg: 'blue.500',
                        color: useColorModeValue('white', 'gray.700'),
                      }}
                ...
                <Box
                  ...
                  shadow="base">
                  <VStack spacing={5}>
                    <form name="contact"  onSubmit={onSubmit} data-netlify="true" data-netlify-honeypot="bot-field">
                    <VisuallyHiddenInput name="bot-field"/>
